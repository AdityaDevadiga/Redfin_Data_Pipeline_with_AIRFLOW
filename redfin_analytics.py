...
job_flow_overrides = {
    ...
    "LogUri": "s3://your_bucket_name/emr-logs-yml/",
    ...
    "Instances": {
        ...
        "Ec2SubnetId": "your_subnet_id_with_the_same_region_as_your_s3_bucket_present",
...
SPARK_STEPS_EXTRACTION = [
    {
        ...
        "HadoopJarStep": {
            "Jar": "s3://your_region.elasticmapreduce/libs/script-runner/script-runner.jar",
            "Args": [
                "s3://your_bucket_name/scripts/ingest.sh",
            ],
        },
    },
   ]
...
SPARK_STEPS_TRANSFORMATION = [
    {
        ...
        "HadoopJarStep": {
            ...
            "Args": ["spark-submit",
            "s3://yoour_bucket_name/scripts/transform_redfin_data.py",
            ],
        },
    },
   ]
